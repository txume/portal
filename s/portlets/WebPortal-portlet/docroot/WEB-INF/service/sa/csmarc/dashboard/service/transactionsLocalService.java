...
/**
 * Provides the local service interface for transactions. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Salem
 * @see transactionsLocalServiceUtil
...
public interface transactionsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link transactionsLocalServiceUtil} to access the transactions local service. Add custom service methods to {@link sa.csmarc.dashboard.service.impl.transactionsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
