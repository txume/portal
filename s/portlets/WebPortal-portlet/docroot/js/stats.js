var testData = testData(['روتينية', 'للتذكير', 'عادي', 'هام'],
...
nv.addGraph(function() {
     ...
     */
    testData[0].y = document.getElementById('RT').innerHTML;
    testData[1].y = document.getElementById('LL').innerHTML;
    testData[2].y = document.getElementById('AD').innerHTML;
    testData[3].y = document.getElementById('HM').innerHTML;
...
*/
    var chart = nv.models.pieChartTotal()
        ...
        .total(function(count){
            return "<div class='visits'>" + count + "<br/> معاملة </div>"
        })
        .donut(true);
